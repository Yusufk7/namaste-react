...
/* App Layout{
    Header(
      -Logo
      -Nav_items(home, about, contact, cart)
    )
    Body()
    Footer()
}*/
  ...
  return (
    <div className="container">
      <div className="logo-container">
        <img
          className="logo"
          src="https://s3.amazonaws.com/cdn.designcrowd.com/blog/39-Food-Delivery-Logos-That-Will-Leave-You-Hungry-For-More/food-delivery-by-andy-zee-dribbble.png"
        />
      </div>
...
const resobj = [
  ...
  },
  {
    info: {
      ...
      name: "McDonald's",
      cloudinaryImageId:
        "RX_THUMBNAIL/IMAGES/VENDOR/2024/4/1/8d8187ee-3d6c-455b-9318-467a37ac274b_334353.jpg",
      locality: "Arihant",
      ...
      availability: {
        nextCloseTime: "2024-04-22 01:01:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-04-22 02:55:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    ...
    analytics: {},
    cta: {
      link: "https://www.swiggy.com/restaurants/zaza-mughal-biryani-gaurav-industrial-estate-kurla-west-mumbai-678582",
      type: "WEBLINK",
    },
  },
  {
    ...
    analytics: {},
    cta: {
      link: "https://www.swiggy.com/restaurants/mealful-rolls-indias-biggest-rolls-gaurav-industrial-estate-kurla-mumbai-678580",
      type: "WEBLINK",
    },
  },
  {
    ...
    analytics: {},
    cta: {
      link: "https://www.swiggy.com/restaurants/itminaan-matka-biryani-slow-cooked-gaurav-industrial-estate-kurla-west-mumbai-678579",
      type: "WEBLINK",
    },
  },
  {
    info: {
      ...
      cloudinaryImageId:
        "RX_THUMBNAIL/IMAGES/VENDOR/2024/4/12/14f0382c-d0ee-42f5-b6fb-4c8b18bb6219_681413.jpg",
      locality: "Gaurav Industrial Estate",
      areaName: "Kurla West",
      costForTwo: "₹250 for two",
    ...
    analytics: {},
    cta: {
      link: "https://www.swiggy.com/restaurants/globo-ice-creams-of-the-world-gaurav-industrial-estate-kurla-west-mumbai-681413",
      type: "WEBLINK",
    },
  },
  {
  ...
  },
  {
    info: {
      ...
      cloudinaryImageId:
        "RX_THUMBNAIL/IMAGES/VENDOR/2024/4/5/66682fca-8a51-4864-91ee-e0e3edf87884_28721.JPG",
      locality: "Kalina",
  ...
  },
  {
    info: {
      ...
      locality: "VALLABHDAS MARG",
      areaName: "SADHANA VIDYALAYA",
      costForTwo: "₹200 for two",
    ...
    analytics: {},
    cta: {
      link: "https://www.swiggy.com/restaurants/the-belgian-waffle-co-vallabhdas-marg-sadhana-vidyalaya-mumbai-674136",
      type: "WEBLINK",
    },
  },
  {
  ...
  },
  {
    ...
    analytics: {},
    cta: {
      link: "https://www.swiggy.com/restaurants/smoor-west-kurla-mumbai-401212",
      type: "WEBLINK",
    },
  },
  {
    ...
    analytics: {},
    cta: {
      link: "https://www.swiggy.com/restaurants/wefit-bowls-salads-and-sandwiches-kurla-malad-west-mumbai-692689",
      type: "WEBLINK",
    },
  },
];
    ...
    <div className="body">
      ...
      <div className="res-list">
        {resobj.map((restaurants) => (
          <RestuarantCard key={restaurants.info.id} resData={restaurants} />
        ))}
      </div>
    </div>
  );
